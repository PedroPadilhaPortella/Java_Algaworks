...
public class PessoaResource
{
	...
	{
		List<Pessoa> pessoasDB = pessoaRepository.findAll();
		return pessoasDB.isEmpty() ? ResponseEntity.noContent().build() : ResponseEntity.ok(pessoasDB);
	}
	...
	public ResponseEntity<Pessoa> buscarPorCodigo(@PathVariable Long codigo)
	{
		...
		return pessoaDB == null ? ResponseEntity.noContent().build() : ResponseEntity.ok(pessoaDB);
	}
